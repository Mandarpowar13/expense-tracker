    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.dashboard}>
        ...
        <View style={styles.panel}>
          <Text style={styles.panelTitle}>Set Monthly Budget</Text>
          <TextInput
            style={styles.input}
        ...
        <View style={styles.panel}>
          <Text style={styles.panelTitle}>Add Expense</Text>
          ...
          <TouchableOpacity style={styles.primaryButton} onPress={handleAddExpense} disabled={busy}>
